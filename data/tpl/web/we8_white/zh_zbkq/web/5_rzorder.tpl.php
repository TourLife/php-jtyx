        ...
        <form action="" method="get" class="col-md-6">
         <input type="hidden" name="c" value="site" />
            ...
            <div class="input-group" style="width: 300px">
                <input type="text" name="keywords" class="form-control" placeholder="请输入昵称/门店名称">
                    ...
                    <table class="yg5_tabel col-md-12">
                        <tr class="yg5_tr1">
                            <td class="store_td1 col-md-1">姓名</td>
                             ...
                             <td class="col-md-1">店铺名称</td>
                            <td class="col-md-1">续费金额</td>
                             <td class="col-md-1">续费时间</td>  
                            <td class="col-md-1">续费天数</td> 
                      ...
                      <?php  if(is_array($list)) { foreach($list as $key => $item) { ?>
                        <tr class="yg5_tr2">
                            ...
                            <td><a class="btn btn-danger btn-sm" href="<?php  echo $this->createWebUrl('rzorder', array('id' => $item['id']))?>" onclick="return confirm('确认删除吗？');return false;" title="删除">删</a></td>
                        </tr>
                        <?php  } } ?>
                        <?php  if(empty($list)) { ?>
                          <tr>
